...
<div class="container-fluid d-flex justify-content-center align-items-center vh-100">
    <div class="container contact-page py-5 px-lg-0">
        ...
        <div class="row justify-content-center">
            <!-- Contact Form Start -->
            <div class="col-md-8 col-lg-6 contact-form wow fadeIn" data-wow-delay="0.1s">
                <h6 class="text-secondary text-uppercase text-center">Get In Touch</h6>
                <h1 class="mb-4 text-center">Contact For Any Query</h1>
                <p class="mb-4 text-center">Feel free to reach out to us for any inquiries or concerns.</p>
